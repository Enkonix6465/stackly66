...
const stats = [
  ...
  { number: 150, suffix: "M+", label: "Recovered for Clients" }
];
...
const values = [
  {
    ...
    description: "We prioritize understanding your unique situation and goals. Every case receives personalized attention from experienced attorneys who take the time to listen and develop strategies tailored to your specific needs."
  },
  {
    title: "Integrity & Transparency",
    description: "We believe in honest communication and ethical practice. Our clients receive straightforward advice about their options, potential outcomes, and costs, with no hidden fees or surprises throughout the legal process."
  },
  {
    title: "Strategic Excellence",
    description: "Our team combines deep legal knowledge with creative problem-solving. We develop innovative approaches to complex legal challenges, drawing on diverse expertise across multiple practice areas to achieve optimal results."
  }
];
  ...
  return (
    <div className="w-full min-h-screen bg-white dark:bg-black">
      ...
      <section ref={sectionRef} className={`py-10 bg-white dark:bg-black relative overflow-hidden`}>
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-6xl mx-auto">
            <div className="grid md:grid-cols-2 gap-16 mb-16">
              <div className={`transition-all duration-700 ease-in-out`}>
                <h2 className={`text-4xl md:text-5xl font-serif font-bold  mb-6`}>
                  Our <span className="text-blue-600">Commitment</span> to Excellence
                </h2>
                <div className="w-24 h-1 bg-blue-600 mb-8"></div>
                <p className={`text-lg  leading-relaxed mb-6`}>
                  Founded on the principles of integrity, expertise, and client dedication, our firm has been serving clients with distinction for over two decades. We combine traditional legal values with innovative approaches to meet today's complex legal challenges.
                </p>
                <p className={`text-lg  leading-relaxed`}>
                  Our attorneys bring diverse perspectives and specialized knowledge to each case, ensuring comprehensive representation that addresses every aspect of your legal needs. We measure our success by your satisfaction and the positive outcomes we achieve together.
                </p>
              </div>
              ...
              <div className={`p-8 rounded-lg border-l-4 border-blue-600 `}>
                ...
                <ul className="space-y-4">
                  ...
                  <li className="flex items-start">
                    ...
                    <span >Clear communication and regular case updates</span>
                  </li>
                  <li className="flex items-start">
                    <div className={`flex-shrink-0 w-6 h-6 ${isDark ? 'bg-blue-900' : 'bg-blue-100'} rounded-full flex items-center justify-center mr-4 mt-1`}>
                      <div className="w-2 h-2 bg-blue-600 rounded-full"></div>
                    </div>
                    <span >Strategic approach tailored to your specific goals</span>
                  </li>
                  <li className="flex items-start">
                    <div className={`flex-shrink-0 w-6 h-6 ${isDark ? 'bg-blue-900' : 'bg-blue-100'} rounded-full flex items-center justify-center mr-4 mt-1`}>
                      <div className="w-2 h-2 bg-blue-600 rounded-full"></div>
                  ...
                  <li className="flex items-start">
                    ...
                    <span >Respect for your time and resources</span>
                  </li>
                </ul>
              </div>
            </div>
            ...
            <div className="mb-1">
              <h3 className={`text-3xl font-serif font-bold text-center ${isDark ? 'text-white' : 'text-white'} mb-12`}>Our Core Values</h3>
      ...
      <section ref={sectionRef} className={`py-10 `}>
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className={`text-3xl md:text-4xl font-serif font-bold mb-4 `}>Case Results & Achievements</h2>
      ...
      <section className={`py-16 `}>
        <div className="container mx-auto px-4">
          <h2 className={`text-4xl font-serif font-bold text-center mb-4`}>
            Client <span style={{ color: '#2874f0' }}>Testimonials</span>
          </h2>
