  ...
  return (
    <div className="w-full min-h-screen bg-white dark:bg-black">
      ...
      <section className="w-full py-20 px-4 bg-white dark:bg-black flex items-center justify-center">
        <div className="max-w-3xl w-full bg-white dark:bg-black rounded-2xl shadow-xl p-8 border border-[#2874f0] dark:border-[#2874f0]">
          <h2 className="text-3xl font-bold text-[#2874f0] mb-6 text-center">
            {t.formTitle}
          </h2>
          <form className="space-y-6">
            ...
            <button
              type="submit"
              className="w-full py-3 bg-[#2874f0] text-white font-bold rounded-lg shadow hover:bg-black transition-all text-lg"
            >
              {t.send}
            </button>
          </form>
      ...
      <section className="w-full py-5 px-4 bg-gradient-to-b from-white to-[#2874f0]/10 dark:from-black dark:to-[#2874f0]/30">
        <div className="w-full">
          <h2 className="text-3xl font-bold text-[#2874f0] mb-8 text-center">
            {t.contactInfo}
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 w-full">
            <div className="bg-[#2874f0] dark:bg-black rounded-2xl shadow-xl p-8 flex flex-col items-center border border-[#2874f0] dark:border-[#2874f0]">
              <i className="fas fa-phone text-3xl text-white dark:text-[#2874f0] mb-3"></i>
              <h3 className="text-lg font-semibold mb-1 text-white dark:text-[#2874f0]">
                {t.phoneLabel}
              </h3>
              <p className="text-white dark:text-[#2874f0] mb-1">
                {t.phoneValue}
              </p>
              <span className="text-sm text-white dark:text-[#2874f0]">
                {t.phoneTime}
              </span>
            </div>
            <div className="bg-[#2874f0] dark:bg-black rounded-2xl shadow-xl p-8 flex flex-col items-center border border-[#2874f0] dark:border-[#2874f0]">
              <i className="fas fa-envelope text-3xl text-white dark:text-[#2874f0] mb-3"></i>
              <h3 className="text-lg font-semibold mb-1 text-white dark:text-[#2874f0]">
                {t.emailLabel}
              </h3>
              <p className="text-white dark:text-[#2874f0] mb-1">
            ...
            <div className="bg-[#2874f0] dark:bg-black rounded-2xl shadow-xl p-8 flex flex-col items-center border border-[#2874f0] dark:border-[#2874f0]">
              <i className="fas fa-map-marker-alt text-3xl text-white dark:text-[#2874f0] mb-3"></i>
              <h3 className="text-lg font-semibold mb-1 text-white dark:text-[#2874f0]">
                {t.locationLabel}
              </h3>
              <p className="text-white dark:text-[#2874f0] mb-1">
      ...
      <section className="w-full py-16 px-0 bg-white dark:bg-black">
        <div className="w-full">
          ...
          <div className="rounded-2xl overflow-hidden shadow-xl border border-[#2874f0] dark:border-[#2874f0] w-full">
            <img
              src={map}
              alt="Company Location Map"
              className="w-full h-[400px] object-cover rounded-2xl shadow-xl border border-[#2874f0] dark:border-[#2874f0]"
            />
          </div>
        </div>
      </section>
